...
$action = optional_param('action', 'create_form', PARAM_TEXT);
...
echo $OUTPUT->footer();
//Preguntar: Si el form puede variar la base de datos, es decir, si en la base de datos decia que tal periodo iba con tal facultad, si al elegir el periodo con otra facultad lo inserta
//o cambia le cambia en la base de datos al periodo la facultad!!!
?>
